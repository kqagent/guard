...
| Live agent (real LLM -> gate -> real q) | **PROVEN (2026-06-12)** | `live_kdb_agent` w/ Haiku: model wrote a date-bounded query, gate allowed, real kdb-x q returned 171 AAPL trades (q reached via `Q_BIN`). |
